    ...
    <section className="py-20 bg-[#12121A]">
      <div className="max-w-5xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="space-y-3 mt-4">
              {[
                ...
                <div key={i} className="flex items-center gap-3">
                  <span className="w-6 h-6 rounded-full bg-[#8B5CF6]/20 flex items-center justify-center text-xs text-[#A78BFA] font-mono shrink-0">
                    {i + 1}
                  </span>
          ...
          {/* Summary Preview */}
          <motion.div className="card-base p-6" {...revealPreset}>
            <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-[#10B981]/10 flex items-center justify-center">
            ...
            <div className="mt-4 rounded-xl bg-white/[0.03] border border-white/5 p-4 text-sm space-y-2">
              ...
              <div>
                ...
                <span className="text-[#10B981]">Summary sent to your phone</span>
              </div>
            </div>
          </motion.div>
        </div>
        ...
        <motion.div className="text-center mt-10" {...revealPreset}>
          <p className="text-[#C4B5FD] mb-4 text-lg">Try it yourself</p>
