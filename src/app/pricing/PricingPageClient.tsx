      ...
      <section className="pb-20">
        <div className="max-w-6xl mx-auto px-6 space-y-6">
          ...
          >
            <motion.div variants={scaleIn} className="will-change-transform">
              <TiltCard className="h-full">
                <article className="glass-card rounded-2xl border border-[#D4A030]/40 bg-[#12121A] p-8 h-full flex flex-col">
                  <p className="text-sm uppercase tracking-wide text-[#D4A030] mb-2">Cadence</p>
                  <h2 className="text-3xl font-semibold mb-2">$199/mo</h2>
                  <p className="text-[#A1A1AA] mb-4">7-day free trial included.</p>
                  <ul className="space-y-2 text-sm text-[#A1A1AA] mb-6 flex-1">
                    ...
                    <li className="flex items-start gap-2.5">
                      <Check className="h-4 w-4 shrink-0 mt-0.5 text-[#D4A030]" aria-hidden />
                      <span>Routes urgent calls to you</span>
                    </li>
                    <li className="flex items-start gap-2.5">
                      <Check className="h-4 w-4 shrink-0 mt-0.5 text-[#D4A030]" aria-hidden />
                      <span>Sends call summary to your phone</span>
                    </li>
                  </ul>
          ...
          <article className="rounded-2xl border border-white/10 bg-[#12121A] p-8 h-full flex flex-col">
            <p className="text-sm uppercase tracking-wide text-[#D4A030] mb-3">Website Creation</p>
            ...
            >
              {websiteTiers.map((tier) => (
                <motion.div
                  ...
                  className={`rounded-xl p-5 border h-full flex flex-col will-change-transform ${tier.featured ? "border-[#D4A030]/50 bg-[#0A0A0F]" : "border-white/10 bg-[#0F0F16]"}`}
                >
                  <p className="text-sm uppercase tracking-wide text-[#D4A030] mb-1">{tier.name}</p>
          ...
          <motion.article
            ...
            viewport={viewportOnce}
          >
            <motion.p className="text-sm uppercase tracking-wide text-[#D4A030] mb-3 will-change-transform" variants={fadeUp}>
              Monthly Plans
            </motion.p>
            ...
            <motion.div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6" variants={staggerContainer} initial={prefersReducedMotion ? false : "hidden"} whileInView="visible" viewport={{ once: true, amount: 0 }}>
              <motion.div variants={staggerItem} className="rounded-xl p-5 border border-white/10 bg-[#0F0F16] h-full flex flex-col will-change-transform">
                ...
                <ul className="space-y-2 text-sm text-[#A1A1AA] flex-1">
                  <li className="flex items-start gap-2.5"><Check className="h-4 w-4 shrink-0 mt-0.5 text-[#D4A030]" aria-hidden /><span>Hosting + uptime monitoring</span></li>
                  <li className="flex items-start gap-2.5"><Check className="h-4 w-4 shrink-0 mt-0.5 text-[#D4A030]" aria-hidden /><span>1 site edit per month</span></li>
                </ul>
              </motion.div>
              <motion.div variants={staggerItem} className="rounded-xl p-5 border border-[#D4A030]/50 bg-[#0A0A0F] h-full flex flex-col will-change-transform">
                <p className="text-sm uppercase tracking-wide text-[#D4A030] mb-1">Growth</p>
                <p className="text-2xl font-semibold mb-3">$299<span className="text-base text-[#A1A1AA]">/mo</span></p>
                <ul className="space-y-2 text-sm text-[#A1A1AA] flex-1">
                  <li className="flex items-start gap-2.5"><Check className="h-4 w-4 shrink-0 mt-0.5 text-[#D4A030]" aria-hidden /><span>Everything in Hosting</span></li>
                  <li className="flex items-start gap-2.5"><Check className="h-4 w-4 shrink-0 mt-0.5 text-[#D4A030]" aria-hidden /><span>2 blog posts per month</span></li>
                  <li className="flex items-start gap-2.5"><Check className="h-4 w-4 shrink-0 mt-0.5 text-[#D4A030]" aria-hidden /><span>Google Business profile updates</span></li>
                  <li className="flex items-start gap-2.5"><Check className="h-4 w-4 shrink-0 mt-0.5 text-[#D4A030]" aria-hidden /><span>Local SEO optimization</span></li>
                  <li className="flex items-start gap-2.5"><Check className="h-4 w-4 shrink-0 mt-0.5 text-[#D4A030]" aria-hidden /><span>Monthly performance report</span></li>
                </ul>
              </motion.div>
            </motion.div>
            <ShimmerButton href="/contact" className="w-fit mt-auto">
          ...
          <motion.article
            ...
            viewport={viewportOnce}
          >
            <p className="text-sm uppercase tracking-wide text-[#D4A030] mb-2">Custom Apps</p>
