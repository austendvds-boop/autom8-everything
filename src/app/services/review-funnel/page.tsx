...
const plans = [
  {
    ...
    price: "$79",
    priceSuffix: "/mo",
    description: "Best for one location or one staff calendar.",
    features: ["1 location or staff calendar", "150 review requests each month", "Magic link login", "Full dashboard"],
  ...
  },
  {
    ...
    price: "$149",
    priceSuffix: "/mo",
    description: "Best for growing teams with multiple locations or providers.",
    features: ["Up to 5 location or staff calendars", "600 review requests each month", "All Starter features"],
  ...
  },
  {
    name: "Pro",
    price: "Let's talk",
    description: "Best for high-volume businesses that want unlimited capacity.",
    features: ["Unlimited calendars", "Unlimited review requests", "All Growth features", "Priority support"],
    ctaLabel: "Contact Us",
    ctaHref: "mailto:hello@autom8everything.com",
