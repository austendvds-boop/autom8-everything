      ...
      <main className="min-h-screen bg-[#0A0A0F]">
        ...
        <section className="py-20">
          <div className="max-w-6xl mx-auto px-6">
            <h2 className="text-3xl font-semibold mb-10" style={{ fontFamily: "var(--font-playfair), serif" }}>
              Documented Wins from Automation Systems
            </h2>
              ...
              {caseStudies.map((study, index) => (
                ...
                >
                  <div className={index % 2 === 1 ? "order-2 lg:order-2" : "order-2 lg:order-1"}>
                    ...
                    <div className="mb-6">
                      <h4 className="text-sm text-[#A1A1AA] uppercase tracking-wide mb-2">Challenge</h4>
                      <p className="text-[#A1A1AA]">{study.challenge}</p>
                    </div>

                    <div className="mb-6">
                      <h4 className="text-sm text-[#A1A1AA] uppercase tracking-wide mb-2">Solution</h4>
                      <p className="text-[#A1A1AA]">{study.solution}</p>
                    </div>

                    <blockquote className="border-l-2 border-[#8B5CF6] pl-4 italic text-[#A1A1AA]">{study.quote}</blockquote>
                  </div>
                  ...
                  <div className={index % 2 === 1 ? "order-1 lg:order-1" : "order-1 lg:order-2"}>
                    <div className="bg-[#12121A] border border-white/5 rounded-2xl p-8">
                      <h4 className="text-sm text-[#A1A1AA] uppercase tracking-wide mb-6">Results</h4>
                      ...
                      <div className="grid grid-cols-3 gap-4 mb-6">
                        {study.results.map((result) => (
                          <div key={result.label} className="text-center">
                            ...
                            <div className="text-xs text-[#A1A1AA]">{result.label}</div>
                          </div>
                        ))}
                      </div>
                    </div>
